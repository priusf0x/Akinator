SOURCES = test.cpp common/simple_parser.cpp graph/graph.cpp stack/stack.cpp common/tools.cpp
...
CFLAGS += -I$(SOURCE_DIR)/  -I$(SOURCE_DIR)/common -I$(SOURCE_DIR)/graph -I$(SOURCE_DIR)/stack
