SOURCES = akinator_main.cpp common/simple_parser.cpp tree/tree.cpp stack/stack.cpp common/tools.cpp tree/tree_dump.cpp visuals/visuals.cpp game/state_machine.cpp game/akinator.cpp common/my_string.cpp
...
CFLAGS += -I$(SOURCE_DIR)/ -I$(SOURCE_DIR)/visuals -I$(SOURCE_DIR)/common -I$(SOURCE_DIR)/tree -I$(SOURCE_DIR)/stack -I$(SOURCE_DIR)/game -lncursesw 
