...
program_state_e GiveObjectDefinition(akinator_t akinator, visualisation_context* screen);
program_state_e CompareTwoObjects(akinator_t akinator, visualisation_context* screen);
